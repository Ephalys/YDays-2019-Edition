    ...
    $(document).ready(function () {
        var app = {
            ...
            init: function () {
                ...
                app.ytInit();
                app.scrollHeader();
                app.animateComponents();
                app.hoverSocials();
                app.percentageAnimation();
                // Remove class active from first grid item
                if($(window).width() < 768){
            ...
            clickMenu: function(){
                $('.wrapper-content .header-menu .hamburger').click(function(){
                    $('.wrapper').unbind('transitionend');
                    $('.wrapper-content').css('top' , -Math.abs(window.pageYOffset));
                    app.state.pageOffset = window.pageYOffset;
                    $('.wrapper').addClass('scale');
                    $('.reducer').addClass('active');
                    $('.reducer-content').addClass('anim');

                    if($(window).width() > 767) {
                        $(window).off('scroll', app.scrollHeader());
                    }
                    if($('.wrapper .header').hasClass('scroll')){
            ...
            scaleUp: function(){
                var _wrapper = $('.wrapper'),
                    _wrapperContent = $('.wrapper-content'),
                    _reducer = $('.reducer'),
                    _reducerContent = $('.reducer-content');

                _wrapper.css('transform', 'translate(0,0)');
                _reducerContent.removeClass('anim');
                _reducer.removeClass('active');

                setTimeout(function() {
                        app.resizeWrapper();
                        _wrapper.removeClass('scale').css('transform', '');
                        _wrapperContent.css('top', 'auto');
                        $(window).scrollTop(app.state.pageOffset);
                    }
                    ,500);
            },
            ...
            returnHome: function(){
                $('.wrapper').on('transitionend', function(){
                    if($('.reducer').hasClass('active')){
                        $('.wrapper , .reducer-menu .hamburger').click(function(){
                            app.scaleUp();
                        });
                        $(window).on('scroll', app.scrollHeader());
                    } else {
                        $('.wrapper , .reducer-menu .hamburger').unbind('click');
                    }
                })
            },
            hoverMenuLink: function(){
                var _menuListItem = $('.menu-list_item');
                var _menuActiveMobile;
                if($(window).width() > 768){
                    _menuListItem.mouseenter(function(){
                        _menuListItem.not($(this)).addClass('disabled');
                        if($(this).hasClass('dropdown')){
                            $(this).addClass('currentItem');
                        }
                    });

                    _menuListItem.mouseleave(function(){
                        _menuListItem.removeClass('disabled currentItem');
                    })
                } else {
                    _menuListItem.click(function(){
                        if($(this).hasClass('dropdown') && !$(this).hasClass('activeMobile')){
                            $(this).addClass('activeMobile');
                            $(this).find('.dropdown-list').slideDown();
                        } else if($(this).hasClass('activeMobile')){
                            $(this).removeClass('activeMobile');
                            $(this).find('.dropdown-list').slideUp();
                        }
                        if(_menuActiveMobile !== undefined){
                            if(!_menuActiveMobile[0].isEqualNode($(this)[0])){
                                $(_menuActiveMobile).removeClass('activeMobile');
                                $(_menuActiveMobile).find('.dropdown-list').slideUp();
                            }
                        }
                        _menuActiveMobile = $(this);
                    })
                }
            },
            clickHomeArrow: function(){
                if(!$('.reducer').hasClass('active')){
                    $('.arrow-scroll').click(function(e){
                        e.preventDefault();
                        if($('.home  .grid').length !== 0){
                            $("html, body").stop().animate( { scrollTop: $('.home  .grid').offset().top - 80}, 900);
                        } else {
                            ...
                            $("html, body").stop().animate( { scrollTop: $(parent).next().offset().top - 80}, 900);
                        }
                    });
                }
            },
            ytInit: function(){
                const player = new Plyr('#player', {
                    controls: [
                        $('.component8-content .player-button') , 'progress', 'current-time', 'duration'
                    ],
                    ratio: $(window).width() < 768 ? '16:16': '16:9',
                    hideControls: true
                });


                $('#player').on('ready', function() {
                    $('.component8-content .player-button').click(function () {
                        player.play();
                    });
                });

                $('#player').on('play',function(){
                    $('.component8-content').addClass('playing');
                });

                $('#player').on('pause', function(){
                    $('.component8-content').removeClass('playing');
                    $('.plyr__poster').hide();
                });

                const player2 = new Plyr('#player2', {
                    controls: [
                        $('.component12-content .player-button') , 'progress', 'current-time', 'duration'],
                });

                $('#player2').on('ready', function() {
                    $('.component12-content .player-button').click(function () {
                        player2.play();
                    });
                });

                $('#player2').on('play',function(){
                    $('.component12-content').addClass('playing');
                });

                $('#player2').on('pause', function(){
                    $('.component12-content').removeClass('playing');
                    $('.plyr__poster').hide();
                });
            },
            ...
            gridInit: function () {
                const _gridItem = $(".grid .grid-item");

                _gridItem.on( "click", function(e) {
                    var _this = $(this),
                        _grid = $('.grid');
                    ...
                    if(_this.hasClass("active")) {
                        ...
                        if(_grid.hasClass('top-left-grid')) {
                            if(_this.hasClass('bottom-left')) {
                                _grid.removeClass('top-left-grid');
                                _grid.addClass('bottom-left-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .bottom-middle').addClass('top-middle').removeClass('bottom-middle');
                                _this.addClass('active').addClass('zoomIn');
                            }
                            if(_this.hasClass('bottom-middle')) {
                                _grid.removeClass('top-left-grid');
                                _grid.addClass('bottom-left-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .bottom-left').addClass('top-middle').removeClass('bottom-left');
                                _this.addClass("active").addClass('bottom-left').removeClass('bottom-middle');
                            }
                            if(_this.hasClass('top-right')) {
                                _grid.removeClass('top-left-grid');
                                _grid.addClass('top-right-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .top-right-2').addClass('top-left-2').removeClass('top-right-2');
                                _this.addClass('active').addClass('zoomIn');
                            }
                            if(_this.hasClass('top-right-2')) {
                                _grid.removeClass('top-left-grid');
                                _grid.addClass('top-right-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .top-right').addClass('top-left-2').removeClass('top-right');
                                _this.addClass("active").addClass('top-right').removeClass('top-right-2');
                            }
                            if(_this.hasClass('bottom-right')) {
                                _grid.removeClass('top-left-grid');
                                _grid.addClass('bottom-right-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .bottom-middle').addClass('top-left-2').removeClass('bottom-middle');
                                $('.grid .top-right-2').addClass('top-middle').removeClass('top-right-2');
                                _this.addClass('active').addClass('zoomIn');
                            }
                            if($(window).width() < 768){
                                if(_this.hasClass('top-left')){
                                    _grid.removeClass('top-right-grid');
                                    _grid.addClass('top-left-grid');
                                    $(".grid .active").removeClass('active');
                                    $('.grid .top-left-2').addClass('top-right-2').removeClass('top-left-2');
                                    _this.addClass('active').addClass('zoomIn');
                                }
                            }
                        }

                        if(_grid.hasClass('top-right-grid')) {
                            if(_this.hasClass('bottom-left')) {
                                _grid.removeClass('top-right-grid');
                                _grid.addClass('bottom-left-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .top-left-2').addClass('top-middle').removeClass('top-left-2');
                                $('.grid .bottom-middle').addClass('top-right-2').removeClass('bottom-middle');
                                _this.addClass('active').addClass('zoomIn');
                            }
                            if(_this.hasClass('bottom-middle')) {
                                _grid.removeClass('top-right-grid');
                                ...
                                $(".grid .active").removeClass('active');
                                $('.grid .top-left-2').addClass('top-middle').removeClass('top-left-2');
                                $('.grid .bottom-left').addClass('top-right-2').removeClass('bottom-left');
                                _this.addClass("active").addClass('bottom-left').removeClass('bottom-middle');
                            }
                            if(_this.hasClass('top-left')) {
                                _grid.removeClass('top-right-grid');
                            ...
                            if(_this.hasClass('top-left-2')) {
                                _grid.removeClass('top-right-grid');
                                _grid.addClass('top-left-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .top-left').addClass('top-right-2').removeClass('top-left');
                                _this.addClass("active").addClass('top-left').removeClass('top-left-2');
                            }
                            if(_this.hasClass('bottom-right')) {
                                _grid.removeClass('top-right-grid');
                                _grid.addClass('bottom-right-grid');
                        ...
                        if(_grid.hasClass('bottom-left-grid')) {
                            if(_this.hasClass('top-middle')) {
                                _grid.removeClass('bottom-left-grid');
                                _grid.addClass('top-left-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .top-left').addClass('bottom-middle').removeClass('top-left');
                                _this.addClass("active").addClass('top-left').removeClass('top-middle');
                            }
                            if(_this.hasClass('top-left')) {
                                _grid.removeClass('bottom-left-grid');
                                _grid.addClass('top-left-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .top-middle').addClass('bottom-middle').removeClass('top-middle');
                                _this.addClass('active').addClass('zoomIn');
                            }
                            if(_this.hasClass('top-right')) {
                                _grid.removeClass('bottom-left-grid');
                                _grid.addClass('top-right-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .top-middle').addClass('top-left-2').removeClass('top-middle');
                                $('.grid .top-right-2').addClass('bottom-middle').removeClass('top-right-2');
                                _this.addClass('active').addClass('zoomIn');
                            }
                            if(_this.hasClass('top-right-2')) {
                                _grid.removeClass('bottom-left-grid');
                                ...
                                $(".grid .active").removeClass('active');
                                $('.grid .top-middle').addClass('top-left-2').removeClass('top-middle');
                                $('.grid .top-right').addClass('bottom-middle').removeClass('top-right');
                                _this.addClass('active').addClass('zoomIn').addClass('top-right').removeClass('top-right-2');
                            }
                            if(_this.hasClass('bottom-right')) {
                                _grid.removeClass('bottom-left-grid');
                                _grid.addClass('bottom-right-grid');
                        ...
                        if(_grid.hasClass('bottom-right-grid')) {
                            if(_this.hasClass('top-middle')) {
                                _grid.removeClass('bottom-right-grid');
                                _grid.addClass('top-right-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .top-right').addClass('bottom-middle').removeClass('top-right');
                                _this.addClass("active").addClass('top-right').removeClass('top-middle');
                            }
                            if(_this.hasClass('top-left')) {
                                _grid.removeClass('bottom-right-grid');
                                _grid.addClass('top-left-grid');
                                $(".grid .active").removeClass('active');
                                $('.grid .top-left-2').addClass('bottom-middle').removeClass('top-left-2');
                                $('.grid .top-middle').addClass('top-right-2').removeClass('top-middle');
                            ...
                            if(_this.hasClass('top-left-2')) {
                                ...
                                $('.grid .top-middle').addClass('top-right-2').removeClass('top-middle');
                                $('.grid .top-left').addClass('bottom-middle').removeClass('top-left');
                                _this.addClass('active').addClass('zoomIn').addClass('top-left').removeClass('top-left-2');
                            }
                            if(_this.hasClass('bottom-left')) {
                                _grid.removeClass('bottom-right-grid');
                                _grid.addClass('bottom-left-grid');
            ...
            animateComponents: function () {
                if($('.component13').length !== 0){
                    var tl = new TimelineMax({onUpdate: updatePercentage});
                    var controller = new ScrollMagic.Controller();

                    tl.from('.component13-right', .1, {y: 300});

                    var scene = new ScrollMagic.Scene({
                        triggerElement: ".component13",
                        offset: '-84',
                        triggerHook: "onLeave",
                        duration: "100%"
                    })
            ...
            hoverSocials: function() {
                var innerCursor;
                var currentHover;

                var positionMouse = function(){
                    $('.socials-js').on('mouseenter', function(){
                        innerCursor = $('.custom-cursor');
                        $(innerCursor).addClass('hovered');
                        currentHover = $(this);
                        clickSocials($(this));
                        getCoordinates();
                        mouseLeave();
                ...
                if($('.socials-js').length !== 0){
                    if($(window).width() > 768){
                        $('window').on('load', positionMouse());
                    } else {
                        clickSocialsMobile();
                    }
                }
                ...
                function getCoordinates(){
                    $(currentHover).bind('mousemove',function (e) {
                        $(innerCursor).css('top', e.clientY - 20);
                        $(innerCursor).css('left', e.clientX - 20);
                    });
                }

                function mouseLeave(){
                    $(currentHover).mouseleave(function(){
                        if($(innerCursor).find('.circle-socials').hasClass('open')){
                            $(innerCursor).find('.circle-socials').removeClass('open');
                        }
                        $(innerCursor).removeClass('hovered , clicked');
                        $(currentHover).unbind('mousemove');
                    });
                }

                function clickSocials() {
                    $('.socials-js').click(function(e) {
                        e.preventDefault();
                        if ($(innerCursor).hasClass('hovered')) {
                            $(innerCursor).addClass('clicked');
                            $(innerCursor).find('i.icon-down-arrow').removeClass().addClass('icon-video-play');
                            $(innerCursor).find('.circle-socials').addClass('open');
                            $(currentHover).addClass('open');
                            $('.wrapper-content').unbind();
                            $(currentHover).unbind();
                            closeOnLeave();
                            closeSocials();
                        }
                ...
                function closeOnLeave(){
                    $('.wrapper-content').on('mousemove',function(e){
                        if (e.pageX < $(currentHover).offset().left - 70 &&
                            e.pageX > 0 ||
                            e.pageX > $(currentHover).outerWidth() + $(currentHover).offset().left + 70 &&
                            e.pageX < $(window).width() ||
                            e.pageY < $(currentHover).offset().top - 70 &&
                            e.pageY > 0 ||
                            e.pageY > $(currentHover).outerHeight() + $(currentHover).offset().top + 70 &&
                            e.pageY < $(document).height()){
                            $(innerCursor).removeClass('hovered , clicked');
                            $(innerCursor).find('.circle-socials').removeClass('open');
                            $(innerCursor).find('.socials-js').removeClass('open');
                            positionMouse();
                            $('.wrapper-content').unbind();
                            $(currentHover).unbind('mousemove');
                        }
                ...
                function closeSocials(){
                    $('.custom-cursor .icon-video-play').click(function(e){
                        e.stopPropagation();
                        if($(innerCursor).hasClass('clicked')){
                            $('.circle-socials').removeClass('open');
                            $(innerCursor).removeClass('clicked');
                            $('.socials-js').removeClass('open');
                            positionMouse();
                        }
                    })
                }

                function clickSocialsMobile(){
                    $('.custom-cursor').click(function(){
                        innerCursor = $(this);
                        currentHover = $(this).parents('.custom-cursor');
                        $(innerCursor).addClass('clicked');
                        $(innerCursor).find('i.icon-down-arrow').removeClass().addClass('icon-video-play');
                        $(innerCursor).find('.circle-socials').addClass('open');
                        $(currentHover).addClass('open');
                        closeSocialsMobile(innerCursor);
                    })
                }

                function closeSocialsMobile(innerCursor){
                    $('.custom-cursor.clicked .icon-video-play').click(function(e){
                        if(!$(innerCursor).hasClass('clicked')){
                            $(this).unbind();
                        } else {
                            e.stopPropagation();
            ...
            percentageAnimation: function () {
                ...
                $('.percent').each(function(i, _item) {
                    var canvasSize = 314,
                        centre = canvasSize / 2,
                        radius = (canvasSize - 12) / 2,
                        s = Snap(_item.nextElementSibling),
                        path = "",
                        arc = s.path(path),
                        startY = centre - radius,
                        percDiv = $(_item).find('h3'),
                        percentValue = parseInt($(_item).data('percent'));
                    ...
                    new ScrollMagic.Scene({ triggerElement: _item, triggerHook: 'onEnter'})
                        .on('start', function () {
                            run(percentValue / 100, canvasSize, centre, radius, s, path, arc, startY, percDiv, percentValue);
                        })
                        .addTo(controller);
                });

                function run(percent, canvasSize, centre, radius, s, path, arc, startY, percDiv, percentValue) {
                    ...
                    Snap.animate(0, endpoint,   function (val) {
                        ...
                        percDiv.html("<h3>"+Math.round(val/360*100) +'%' +"</h3>");
                    }, 2000, mina.easeinout);
                }
            }
        };
